...
<div style="width: 25%; height: 71.31px;">
	<div style="width: 100%; height: 56.49px; font-size: 14px; pading: 7.65px 0px 7.2px; text-align: center; line-height: 56.49px; color: #444444;">01. 장바구니</div>
	<div style="width: 100%; height: 2px; background-color: #444444;"></div>
</div>
<div style="width: 25%; height: 71.31px;">
	<div style="width: 100%; height: 56.49px; font-size: 14px; pading: 7.65px 0px 7.2px; text-align: center; line-height: 56.49px; color: #999999;">02. 주문서 작성</div>
	<div style="width: 100%; height: 2px; background-color: #eeeeee;"></div>
</div>
<div style="width: 25%; height: 71.31px;">
	<div style="width: 100%; height: 56.49px; font-size: 14px; pading: 7.65px 0px 7.2px; text-align: center; line-height: 56.49px; color: #999999;">03. 결제 완료</div>
	<div style="width: 100%; height: 2px; background-color: #eeeeee;"></div>
</div>
<div style="width: 25%; height: 71.31px;">
	<div style="width: 100%; height: 56.49px; font-size: 14px; pading: 7.65px 0px 7.2px; text-align: center; line-height: 56.49px; color: #999999;">04. 주문 완료</div>
	<div style="width: 100%; height: 2px; background-color: #eeeeee;"></div>
</div>
</div>
...
<div id="cart-pro-list-area">
	...
	<div id="input-sel-div-area">
		...
		<div id="cart-sel-proInfo-text"> <!-- 40 -->
			...
			<input type="hidden" value="${proList.productsCode}" id="proCode${loopStatus.index}" name="productsCode">
		</div>
		<div id="cart-sel-img-text"> <!-- 3 -->
