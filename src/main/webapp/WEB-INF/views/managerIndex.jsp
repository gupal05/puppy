...
<div class="navBar-area" style="display: none; position: fixed; z-index: 999; justify-content: space-between;">
	<div style="padding: 0px 20px; font-size: 20px; display: flex; width: 7.3%;">
		<div style="height: 100%; margin-left: 10px; margin-right: 10px; line-height: 55px;">
			<i class="fa-solid fa-bars" onclick="aa()"></i>
		</div>
		<div style="height: 100%; margin-left: 10px; margin-right: 10px; line-height: 53px;">
...
<div id="secLine">
		...
		<div id="rr">
			...
			<div id="rr-icon">/</div>
			<div id="rr-tooltip" class="user-tooltip-box-area">
  				<div id="in-myBox">
			...
			<input type="button" value="${user.userName}" style="color: #31CAAE;" class="user-info-btn" id="rr-btn" onclick="toggleTooltip()">
		</div>
</div>
<div id="line"></div>
<div id="logoArea">
...
<div id="categories">
	<div id="cateIn">
		...
		<div id="ci" class="snackCate" onmouseover="cateD('snack')" onmouseout="hideCate('snack')">간식</div>
		<div id="ci" class="toyCate" onmouseover="cateD('toy')" onmouseout="hideCate('toy')">장난감/훈련용품</div>
		<div id="ci" class="feedCate" onmouseover="cateD('feed')" onmouseout="hideCate('feed')">사료/영양제</div>
		<div id="ci" class="hairCate" onmouseover="cateD('hair')" onmouseout="hideCate('hair')">미용용품</div>
		<div id="ci" class="cleanCate" onmouseover="cateD('clean')" onmouseout="hideCate('clean')">위생용품</div>
		<div id="ci" class="dishCate" onmouseover="cateD('dish')" onmouseout="hideCate('dish')">식기</div>
		<div id="ci" class="walkCate" onmouseover="cateD('walk')" onmouseout="hideCate('walk')">외출용품</div>
		<div id="ci" class="houseCate" onmouseover="cateD('house')" onmouseout="hideCate('house')">집/쿠션</div>
		<div id="ci">검색</div>
	</div>
</div>
<div id="navLine"></div>
...
<div class="toggleCate">
	<div class="cateText" id="snack" style="height: 259px; visibility: hidden;" onmouseover="showCate('snack')" onmouseout="hideCate('snack')">
			<div class="cateText-in" onclick="getProductPage('1')">전체</div>
			<div class="cateText-in" onclick="getProductPage('1-0')">강아지껌</div>
			<div class="cateText-in" onclick="getProductPage('1-1')">비스킷/스낵</div>
			<div class="cateText-in" onclick="getProductPage('1-2')">수제간식</div>
	...
	<div class="cateText" id="toy" style="height: 222px; visibility: hidden;" onmouseover="showCate('toy')" onmouseout="hideCate('toy')">
		<div class="cateText-in" onclick="getProductPage('0')">전체</div>
		<div class="cateText-in" onclick="getProductPage('0-0')">공/원반</div>
		<div class="cateText-in" onclick="getProductPage('0-1')">인형</div>
		<div class="cateText-in" onclick="getProductPage('0-2')">노즈워크</div>
	...
	<div class="cateText" id="feed" style="height: 222px; visibility: hidden;" onmouseover="showCate('feed')" onmouseout="hideCate('feed')">
		<div class="cateText-in" onclick="getProductPage('2')">전체</div>
		<div class="cateText-in" onclick="getProductPage('2-0')">건식사료</div>
		<div class="cateText-in" onclick="getProductPage('2-1')">습식사료</div>
		<div class="cateText-in" onclick="getProductPage('2-2')">우유/분유</div>
	...
	<div class="cateText" id="hair" style="height: 296px; visibility: hidden;" onmouseover="showCate('hair')" onmouseout="hideCate('hair')">
		<div class="cateText-in" onclick="getProductPage('3')">전체</div>
		<div class="cateText-in" onclick="getProductPage('3-0')">드라이기</div>
		<div class="cateText-in" onclick="getProductPage('3-1')">발톱관리</div>
		<div class="cateText-in" onclick="getProductPage('3-2')">브러시</div>
	...
	<div class="cateText" id="clean" style="height: 370px; visibility: hidden;" onmouseover="showCate('clean')" onmouseout="hideCate('clean')">
		<div class="cateText-in" onclick="getProductPage('4')">전체</div>
		<div class="cateText-in" onclick="getProductPage('4-0')">구강위생용품</div>
		<div class="cateText-in" onclick="getProductPage('4-1')">기저귀</div>
		<div class="cateText-in" onclick="getProductPage('4-2')">배변봉투</div>
	...
	<div class="cateText" id="dish" style="height: 222px; visibility: hidden;" onmouseover="showCate('dish')" onmouseout="hideCate('dish')">
		<div class="cateText-in" onclick="getProductPage('5')">전체</div>
		<div class="cateText-in" onclick="getProductPage('5-0')">급수기</div>
		<div class="cateText-in" onclick="getProductPage('5-1')">급식기</div>
		<div class="cateText-in" onclick="getProductPage('5-2')">정수기</div>
	...
	<div class="cateText" id="walk" style="height: 370px; visibility: hidden;" onmouseover="showCate('walk')" onmouseout="hideCate('walk')">
		<div class="cateText-in" onclick="getProductPage('6')">전체</div>
		<div class="cateText-in" onclick="getProductPage('6-0')">가슴줄</div>
		<div class="cateText-in" onclick="getProductPage('6-1')">리드줄</div>
		<div class="cateText-in" onclick="getProductPage('6-2')">목걸이/인식표</div>
	...
	<div class="cateText" id="house" style="height: 333px; visibility: hidden;" onmouseover="showCate('house')" onmouseout="hideCate('house')">
		<div class="cateText-in" onclick="getProductPage('7')">전체</div>
		<div class="cateText-in" onclick="getProductPage('7-0')">계단/스텝</div>
		<div class="cateText-in" onclick="getProductPage('7-1')">매트</div>
		<div class="cateText-in" onclick="getProductPage('7-2')">안전문</div>
...
<section>
	...
	<c:forEach var="img" items="${best.imgList}">
		<div id="bestProduct" style="cursor: pointer;" onclick="showProduct('${best.productsCode}')">
	...
	<c:forEach var="image" items="${newItem.imgList}">
		<div id="bestProduct" style="cursor: pointer;" onclick="showProduct('${newItem.productsCode}')">
...
document.addEventListener('DOMContentLoaded', function() {
	var userData = '${userInfo.userPhone}';
	if(userData == null || userData == ''){
		alert("카카오/네이버 로그인 회원님은 정보수정이 필수입니다.")
		serverCallByRequest("modifyUserInfo","post",'');
	}else{
		console.log("y");
	}
});
...
//툴팁 영역 보이기
document.getElementsByClassName('user-info-btn')[0].addEventListener('mouseover', function() {
    const tool = document.getElementsByClassName('user-tooltip-box-area')[0];
    tool.style.display = 'block';
});

// 툴팁 영역 밖으로 마우스가 벗어나면 숨기기
document.getElementsByClassName('user-tooltip-box-area')[0].addEventListener('mouseout', function(event) {
...
// 툴팁 영역 안으로 마우스가 들어오면 숨기지 않음
document.getElementsByClassName('user-tooltip-box-area')[0].addEventListener('mouseover', function() {
    const tool = this;
    tool.style.display = 'block';
});

// 버튼 영역 밖으로 마우스가 벗어나면 숨기기
document.getElementsByClassName('user-info-btn')[0].addEventListener('mouseout', function(event) {
    const relatedTarget = event.relatedTarget;
    if (!this.contains(relatedTarget)) {
        const tool = document.getElementsByClassName('user-tooltip-box-area')[0];
...
function cateD(category) {
	...
	var cateTexts = document.getElementsByClassName('cateText');
