...
<div id="miniText">
	<div id="miniIn">
		...
		<div id="miniArrow">></div>
		<div id="miniJoinText">비밀번호 찾기 완료</div>
	</div>
</div>
<div id="joinTitle">
	FIND PASSWORD
...
<div id="findIdInfoArea">
	...
	<div id="findIdInfo">
		...
		<div style="display: flex;">
			<div id="findUserIdResult">name :</div>
			<div id="findIdEl">${findName}</div>
		</div>
		<div id="findBoxLine-top"></div>
		<div style="display: flex;">
			<div id="findUserIdResult">mail :</div>
			<div id="findIdEl">${findMail}</div>
		</div>
		<div id="findBoxLine-top"></div>
		<div style="display: flex;">
			<div id="findUserIdResult">ID :</div>
			<div id="findIdEl">${findId}</div>
		</div>
		<div id="findBoxLine-top"></div>
		<div style="display: flex;">
			<div id="findUserIdResult">PW :</div>
			<div id="findIdEl">${findPw}</div>
		</div>
		<div id="findBoxLine-top"></div>
	</div>
	</div>
