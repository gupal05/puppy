...
<div id="miniText">
	<div id="miniIn">
		...
		<div id="miniArrow">></div>
		<div id="miniJoinText">아이디 찾기</div>
	</div>
</div>
<div id="joinTitle">
	FIND ID
...
<div id="joinTextArea">이메일 인증을 통해<br>
아이디를 찾아주세요.</div>
<div id="joinLine"><i class="fa-solid fa-diamond" id="diaIcon"></i></div>
<div id="findArea">
	<div id="findInputArea">
		...
		<div style="flex-direction: column; display: flex; justify-content: flex; text-align: left;">
			...
			<div style="margin: 0 auto;">
				<button id="find-btn" onclick="findUserId()"><i class="fa-solid fa-check" style="margin-right: 3px;"></i>아이디 찾기</button>
