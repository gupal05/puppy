...
<script>
  Kakao.init('44b5a80b31fd80525b514d53134ab00b');
</script>
<!-- Core theme JS-->
...
<div id="loginArea">
	<div id="loginAreaDetail">
		<div id="login-text">
			로그인
		</div>
		<div style="width: 100%; height: 1px; background-color: #F0F0F0; margin: 5px 0px 4px;"></div>
		<div id="loginBottom">
		<div id="login-id-text-big">
			<div style="width: 375px; height: 58.27px;">
				<input type="text" id="login-id-inputBox" name="userId" class="userId" placeholder="ID">
			</div>
		</div>
		<div id="login-id-text-big">
			<div style="width: 375px; height: 58.27px;">
				<input type="password" id="login-id-inputBox" name="userPw" class="userPw" placeholder="PW">
			</div>
		</div>
		<div id="login-id-text-big">
			<div style="width: 375px; height: 58.27px;">
				<button id="login-result-btn" style="cursor: pointer;" onclick="login()">login</button>
				<div style="display: flex;">
				<a onclick="kakaoLogin()" style="cursor: pointer;"><img height="38px" width="175.71px" src="resources/img/kakao-btn.png"/></a>
				<div id="naverIdLogin" style="margin-left: 22px;"></div>
				</div>
			</div>
		</div>
		<div style="width: 100%; height: 1px; background-color: #F0F0F0; margin: 50px 0px 19px;"></div>
		</div>
		<div id="find">
			<button id="findId-btn" onclick="serverCallByRequest('findId','get','')"><i class="fa-solid fa-magnifying-glass" style="margin-right: 5px;"></i>아이디 찾기</button>
			<button id="findPw-btn" onclick="serverCallByRequest('findPw','post','')"><i class="fa-solid fa-lock" style="margin-right: 5px;"></i>비밀번호 찾기</button>
			<button id="findJoin-btn" onclick="serverCallByRequest('join','get','')"><i class="fa-solid fa-right-to-bracket" style="margin-right: 5px;"></i>회원가입</button>
		</div>
	</div>
</div>
