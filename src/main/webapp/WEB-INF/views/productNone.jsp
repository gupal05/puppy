		...
		<div id="title-text-area">
			...
			<div id="dot-trd">ㆍ</div>
				...
				<div id="productCount-numBox">
					<input type="text" id="count-num-box" value="1">
					<div>
			...
			<div style="display: flex;">
				<div style="width: 284.23px; height: 57.64px; padding: 3px;">
					<button id="buy-btn" onclick="notUser()">B U Y</button>
				</div>
				<div style="width: 139.11px; height: 57.64px; padding: 3px;">
					<button id="cart-btn" onclick="notUser()" style="text-align: center;"><i class="fa-solid fa-cart-shopping" style="margin-right: 5px;"></i>C A R T</button>
				</div>
				<div style="width: 139.11px; height: 57.64px; padding: 3px;">
					<button id="wish-btn" onclick="notUser()" style="text-align: center;"><i class="fa-regular fa-star" style="margin-right: 5px;"></i>W I S H</button>
				</div>
			</div>
			</div>
		</div>
