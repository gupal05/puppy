...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div style="margin-left: -15px;">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="#!" onClick="serverCallByRequest('addProduct','post','')">상품 등록</a></li>
							<li><a class="dropdown-item" href="#!" onClick="serverCallByRequest('cp','post','')">상품 수정</a></li>
						</ul></li>
				</ul>
				</div>
				<div style="margin-left: -15px;">
	...
	<!-- Header-->
		<div class="container px-4 px-lg-5 my-5" style="margin-bottom: -2.5rem;">
    <div class="slideshow-container">
        <img src="resources/img/슬라이드3.jpg" alt="로고" width="1300px" height="400px" class="mySlides fade">
            <!-- <img src="resources/img/minon.jpg" alt="로고" width="350px" height="350px"> -->
        <img src="resources/img/c4f80a5d10178e13cb76c6b9dcf3fdb2.jpg" alt="로고" width="1300px" height="400px" class="mySlides fade">
            <!-- <img src="resources/img/c4f80a5d10178e13cb76c6b9dcf3fdb2.jpg" alt="로고" width="1300px" height="400px"> -->
        <img src="resources/img/슬라이드2.jpg" alt="로고" width="1300px" height="400px" class="mySlides fade">
...
<div class="mainText">인기상품</div>
            ...
            <c:forEach var="product" items="${products}">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="resources/productImg/${product.message}" width="238px" height="250px" alt="Product Image" />
                        <!-- Product details-->
	...
	function showSlides() {
	    ...
	    setTimeout(showSlides, 3500); // 3.5초마다 슬라이드 변경
	}
