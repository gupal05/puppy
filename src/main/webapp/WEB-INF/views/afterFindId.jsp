...
<div id="miniText">
	<div id="miniIn">
		...
		<div id="miniArrow">></div>
		<div id="miniLoginText">아이디 찾기</div>
		<div id="miniArrow">></div>
		<div id="miniJoinText">아이디 찾기 완료</div>
	</div>
</div>
<div id="joinTitle">
	FIND ID
...
<div id="findTextArea">고객님의 계정을 찾았습니다.</div>
<div id="joinLine"><i class="fa-solid fa-diamond" id="diaIcon"></i></div>
<div id="findIdInfoArea">
	<div id="thxText">저희 쇼핑몰을 이용해주셔서 감사합니다.<br>
		다음 정보로 가입된 계정입니다.
	</div>
	<div style="width: 100%; height: 1px; background-color: #eee; margin: 20px 0px 19px;"></div>
	<div style="display: flex;">
	<div style="width: 35px; height: 163px; padding: 30px;">
		<i id="userIcon" class="fa-regular fa-user"></i>
	</div>
	<div id="findIdInfo">
		<div id="findBoxLine-top"></div>
		<div style="display: flex;">
			<div id="findUserIdResult">이름 :</div>
			<div id="findIdEl">${findName}</div>
		</div>
		<div id="findBoxLine-top"></div>
		<div style="display: flex;">
			<div id="findUserIdResult">이메일 :</div>
			<div id="findIdEl">${findMail}</div>
		</div>
		<div id="findBoxLine-top"></div>
		<div style="display: flex;">
			<div id="findUserIdResult">아이디 :</div>
			<div id="findIdEl">${findId}</div>
		</div>
		<div id="findBoxLine-top"></div>
	</div>
	</div>
	...
	<div style="margin: 0 auto;">
				<button id="find-btn" onclick="serverCallByRequest('login','get','')"><i class="fa-solid fa-check" style="margin-right: 3px;"></i>로그인</button>
				<button id="find-pw-btn" onclick="serverCallByRequest('findPw','post','')">비밀번호 찾기</button>
			</div>
</div>
<!-- Footer 내용 추가 -->
<footer id="footer">
